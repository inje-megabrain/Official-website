      ...
      <Container gap={0}>
            ...
            <Card variant="bordered">
              ...
              <Card.Body>
                <Text h6 size={15} css={{ m: 0 }}>
                  좋은 경험과 습관을 가진 지속 가능한 개발자 양성을 목표로 여러
                  선배들이 모여 만들어낸 웹 개발 중심의 인제대학교
                  컴퓨터공학과의 학술 동아리입니다.
                </Text>
              </Card.Body>
            </Card>
            ...
            <Card css={{ $$cardColor: "$colors$primary" }}>
              ...
              <Card.Body>
                <Text h6 size={15} color="white" css={{ m: 0 }}>
                  ...
                  형성합니다. 학교에서 경험하지 못하는 웹 개발 전문 지식을 함께
                  나누며 성장합니다.
                </Text>
              </Card.Body>
              <Card.Footer>
        ...
        <Link href="/apply" css={{ width: "100%", textAlign: "center" }}>
          <Button
            ...
            color="primary"
            size="xl"
            css={{ width: "100%", height: 100, textAlign: "center", mx: 100, my: 30 }}
          >
            <Text
              css={{ color: "inherit" }}
              size={25}
