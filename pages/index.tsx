...
const Home: NextPage = () => {
    return (
        <>
            ...
            좋은 경험과 습관을 가진 지속 가능한 개발자 양성을 목표로, 여러 선배들이 모여 만들어낸 소프트웨어 학술 동아리입니다. 누구에게나 열려 있는 기회, 그러나 강도 높은 주도적인 문제 해결의 경험을 제공합니다. 세상이 빠르게 변하는 만큼 부스트캠프는 매년 새로운 시도들로 새로운 가능성을 찾습니다.
            </Typography>
            ...
            <Paper variant="outlined" square className={styles.rows}>
                <h2>메가브레인은 성장하는 학생들을 위한 부트캠프입니다</h2>
